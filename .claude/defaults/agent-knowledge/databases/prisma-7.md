...
When working with Prisma 7 patterns, use:
...
- Use singleton pattern to avoid connection exhaustion
- `DIRECT_URL` for dev, `DATABASE_URL` for production
- See `integrations/nextjs-prisma.md`
